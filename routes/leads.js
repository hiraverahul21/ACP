...
const createLeadValidation = [
  ...
  body('service_type')
    .isIn(['RESIDENTIAL_PEST_CONTROL', 'COMMERCIAL_PEST_CONTROL', 'TERMITE_CONTROL', 'RODENT_CONTROL', 'COCKROACH_CONTROL', 'MOSQUITO_CONTROL', 'BED_BUG_CONTROL', 'BIRD_NETTING', 'SANITIZATION', 'DISINFECTION'])
  ...
  body('lead_type')
    .notEmpty()
    .isIn(['ONCALL', 'AMC'])
    .withMessage('Lead type is required and must be either ONCALL or AMC'),
